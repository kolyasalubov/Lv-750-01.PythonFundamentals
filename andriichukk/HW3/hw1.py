...
# first = zenofpython.count("better")
# second = zenofpython.count("never")
# third = zenofpython.count("is")
# print(first)
# print(second)
# print(third)
...
uppercase = zenofpython.upper()
print(uppercase)

# eplace all occurrences of the symbol "i" with "&"

symbol = zenofpython.replace("i","&")
print(symbol)