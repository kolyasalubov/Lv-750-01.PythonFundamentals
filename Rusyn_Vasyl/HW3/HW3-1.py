...
quantity_better = text.count("better")
quantity_never = text.count("never")
quantity_is = text.count("is")
print(f"Occurrences of 'better': {quantity_better}")
print(f"Occurrences of 'never': {quantity_never}")
print(f"Occurrences of 'is': {quantity_is}")
