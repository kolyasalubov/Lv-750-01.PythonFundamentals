...
print ("word \"better \" appears:", philosophy.count('better')+philosophy.count('Better'), "times")
print ("word \"never \" appears:", philosophy.count('never')+philosophy.count('Never'), "times")
print ("word \"is \" appears:", philosophy.count('is')+philosophy.count('Is'), "times")

print ("philosophy in Uppercase:", philosophy.upper())

print ("replaced all occurrences of the symbol \"i\"", philosophy.replace('i' and 'I', '&'))
